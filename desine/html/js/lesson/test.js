...
<textarea name="code" class="usercode_main">class Car(object):11111111111111111111111111111111111111111213                                                      2
            ...
            this.$textarea.addEventListener('input', () => {
                    ...
                    if (row[0].length > maxCountCharsOfLine) {
                        ...
                        for (const index in words) {
                            ...
                            if (newLine.length > maxCountCharsOfLine) {
                                print('newLine', [newLine])
                                print('line', [line])
                                print('newLine.slice(maxCountCharsOfLine)', [newLine.slice(maxCountCharsOfLine)])
                                // count splice

                                if (line.slice(maxCountCharsOfLine).length) {
                                    print('***line', [line])
                                    // while (true) {
                                        print('*', [line.slice(0, maxCountCharsOfLine)])
                                        print('*', [line.slice(maxCountCharsOfLine)])

                                        paragraphs.push(line.slice(0, maxCountCharsOfLine))
                                        print('line', [line])
                                        print('word', [word])
                                        line = line.slice(maxCountCharsOfLine) + word
                                        if (!line.slice(maxCountCharsOfLine).length) {
                                            // line = line.slice(maxCountCharsOfLine)
                                            break
                                        } else {
                                            // line = line.slice(maxCountCharsOfLine) + word
                                        }
...
//
// class Car(object):11111111111111111111111111111111111111111213
//                2
//     def __init__(self, name, year):
//         self.name = name
//         self.year = year
...
// class Car(object):11111111111111111111111111111111111111111213                                                                                                                                     2
//     def __init__(self, name, year):
//         self.name = name
//         self.year = year
//
